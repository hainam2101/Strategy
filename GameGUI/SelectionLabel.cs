...
namespace Strategy.GameGUI {
	...
	class SelectionLabel : Label {
		...
		/// <summary>
		/// Creates instance of the Label and stores an order and a panelType. Also adds MouseClick action depending on the panelType.
		/// </summary>
		...
		/// <summary>
		/// Creates instance of the Label and stores an order, a object to store and a panelType and closing panel reference. 
