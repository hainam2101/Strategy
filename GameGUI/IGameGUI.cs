...
namespace Strategy.GameGUI {
	/// <summary>
	/// Represents interface for GUI. Has base method which are required by the application.
	/// </summary>
	public interface IGameGUI {
		...
		/// <summary>
		/// Shows current targeted (given) GroupStatics group (properties, count,...).
		/// </summary>
		/// <param name="group">The actual targeted group.</param>
		void ShowTargeted(GroupStatics group);

		/// <summary>
		/// Shows current targeted (given) GroupMovables group (properties, count,...).
		/// </summary>
		/// <param name="group">The actual targeted group.</param>/>
		void ShowTargeted(GroupMovables group);

		/// <summary>
		/// Sets SolarSystem name to the relevant Label. 
		/// </summary>
