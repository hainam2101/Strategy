...
namespace Strategy.FightMgr {
	...
	/// <summary>
	/// Represents fight between two groups (attacking group and deffending groups).
	/// Implements two interfaces therefore that it could get information about the object reached destination (move)
	...
	public class Fight : IBulletStopReciever, IFinishMovementReciever {
		...
		// Represents squared maximum distance between fighting objects. When is distance bigger so object stop fighting.
		...
		/// </summary>
		/// <param name="gameObject">The disabled IGameObject</param>
		public static void DisableAttackGameObject(IGameObject gameObject) {
			// Unused functions in the thesis. It should be used for discarding objects from the fight. (disable)
		...
		/// </summary>
		/// <param name="gameObject">The enabled IGameObject</param>
		public static void EnableAttackGameObject(IGameObject gameObject) {
			// Unused functions in the thesis. It should be used for discarding objects from the fight. (enable)
			if (canAttack.ContainsKey(gameObject)) {
		...
		/// </summary>
		/// <param name="gameObject">The object which attacking the target.</param>
		...
		/// <summary>
		/// Gets damage to hitted target from the bullet.
		/// </summary>
		/// <param name="bullet">The bullet that hit the target.</param>
		/// <param name="hittedObject">The object that is hitted.</param>
		...
		/// <summary>
		/// Receives information that the object interupted a movement.
		...
		/// <summary>
		/// Checks distance between the object and the target. Compares the distance with
		/// a maximum distance constant and return if the target is in range.
		/// </summary>
		/// <returns>Returns if the target is in a range distance.</returns>
		...
		/// <returns>Returns if freeze dictionary contains the given object (is freezed) or not.</returns>
		...
		/// <summary>
		/// Starts attack of both groups. Also sets DieHandler to reached a message about
		/// objects death.
		/// </summary>
		...
		/// <summary>
		/// Selects a target to attackers and checks if any deffender is alive (ends fight).
		/// </summary>
		...
		/// <summary>
		/// Ends the fight for each object which was participated.
		/// </summary>
