...
namespace Strategy.FightMgr {
	/// <summary>
	/// Represents a occupation of the target by the attackers. Controls distance between target and attackers
	/// and occupying time.
	/// </summary>
	public class Occupation {
		...
		/// <summary>
		/// Creates Property with remaining time to the end of the occupying.
		/// This Property is added to occupied object (to objects properties).
		/// </summary>
		/// <param name="occupier">The attacking group.</param>
		/// <param name="occupied">The target of the occupation.</param>
		public Occupation(GroupMovables occupier, IGameObject occupied)
			: this(occupier, occupied, TimeSpan.FromSeconds(occupied.OccupyTime)) {
		}

		#region Public

		/// <summary>
		/// Checks if occupation contains the given object.
		/// </summary>
		/// <param name="igo">The testing object.</param>
		/// <returns>Returns if occupation contains the given object.</returns>
		...
		/// <summary>
		/// Checks if the occupation continues, is done or if is canceled.
		/// </summary>
		...
		/// <summary>
		/// Removes property with an occupation time from target properties, play finish occupation sound 
