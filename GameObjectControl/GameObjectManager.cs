...
namespace Strategy.GameObjectControl {
	/// <summary>
	/// Checks and updates the control elements of the game and allow access to some of them.
	/// </summary>
	public class GameObjectManager {

		private ObjectCreator objectCreator;
		private IMoveManager moveMgr;
		private IFightManager fightMgr;
		private PropertyManager propertyMgr;
		private TeamManager teamMgr;
		private GroupManager groupMgr;
		private SolarSystemManager solarSystemMgr;
		...
		/// </summary>
		/// <exception cref="System.NullReferenceException">Thrown when GroupManager is not initialized.</exception>
		...
		/// </summary>
		/// <exception cref="System.NullReferenceException">Thrown when IGameObjectCreator is not initialized.</exception>
		...
		/// </summary>
		/// <exception cref="System.NullReferenceException">Thrown when HitTest is not initialized.</exception>
		...
		/// </summary>
		/// <exception cref="System.NullReferenceException">Thrown when MoveManager is not initialized.</exception>
		...
		/// </summary>
		/// <exception cref="System.NullReferenceException">Thrown when IFightManager is not initialized.</exception>
		...
		/// </summary>
		/// <exception cref="System.NullReferenceException">Thrown when PropertyManager is not initialized.</exception>
		...
		/// </summary>
		/// <exception cref="System.NullReferenceException">Thrown when TeamManager is not initialized.</exception>
		...
		/// </summary>
		/// <exception cref="System.NullReferenceException">Thrown when SolarSystemManager is not initialized.</exception>
		...
		/// Returns instance of SolarSystemManager (if it is not initialize throws a exception).
		/// </summary>
		/// <exception cref="System.NullReferenceException">Thrown when GameSerializer is not initialized.</exception>
		...
		/// removes it from the current group (has new owner). 
		/// </summary>
