...
namespace Strategy.GameObjectControl.Game_Objects.MovableGameObjectBox {
	...
	public class SpaceShip2 : MovableGameObject {
		...
		/// <summary>
		/// Returns a type of the current acquired bullet (Missile2).
		/// </summary>
		...
		/// <summary>
		/// Return a maximum attack distance of the current acquired bullet.
		/// </summary>
		...
		/// <summary>
		/// Return a cooldown of the current acquired bullet.
		/// </summary>
