...
namespace Strategy.GameObjectControl.Game_Objects.MovableGameObjectBox {
	...
	public abstract class MovableGameObject : GameObject, IMovableGameObject {
		...
		/// <summary>
		/// The dictionary which contains bonuses for the object properties.
		/// </summary>
		protected Dictionary<string, object> propertyBonusDict;

		/// <summary>
		/// The initial number of HPs.
		/// </summary>
		...
		/// is in active SolarSystem (SceneNode is setted). Controls distance from destination,
		...
		/// <summary>
		/// Checks if exist next position to go.
		/// </summary>
		...
		/// <summary>
		/// The property with the attacking target.
		/// </summary>
		protected Property<IGameObject> target;

		/// <summary>
		/// The dictionary with types of the bullets and reloading time.
		/// </summary>
		...
		/// <summary>
		/// Decreases cooldowns by a delay and if the object is in "attack" mode, it calls Attack()
		/// </summary>
		/// <param name="delay">The delay between last two frames (seconds).</param>
		...
		/// <summary>
		/// Return a type of the current acquired bullet.
		/// </summary>
		...
		/// <summary>
		/// This prototype of movable object returns empty dictionary (no bonuses for group members).
		/// </summary>
		...
		/// <summary>
		/// Subtracts receives damage from the current Hp. If the health is lower then 0 so RaiseDie is called.
		/// </summary>
