...
namespace Strategy.GameObjectControl.Game_Objects.MovableGameObjectBox {
	/// <summary>
	/// Represents all movable game objects (units) in the game. All object which implements this interface 
	...
	public interface IMovableGameObject : IGameObject {
		...
		/// <summary>
		/// Changes current object position.
		/// </summary>
		...
		/// <param name="hitObject">The result of the HitTest.</param>
