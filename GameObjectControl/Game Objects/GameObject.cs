...
namespace Strategy.GameObjectControl.Game_Objects {
	...
	public abstract class GameObject : IGameObject {
		...
		/// <summary>
		/// Indicates if the object is in visible mode ( in visible solar system).
		/// </summary>
		protected bool isVisible;

		/// <summary>
		/// Mogre Entity for the object.
		/// </summary>
		protected Mogre.Entity entity;

		/// <summary>
		/// Mogre SceneNode for the object.
		/// </summary>
		protected Mogre.SceneNode sceneNode;

		/// <summary>
		/// The name of the mesh for the object.
		/// </summary>
		...
		/// <summary>
		/// The Fight which leads objects attack.
		/// </summary>
		...
		/// <summary>
		/// Returns Vector3 with a current position of the object.
		/// </summary>
		...
		/// </summary>
		/// <param name="propertyName">The string with a name of the removing Property.</param>
		...
		/// <summary>
		/// Returns Property with the given name (from userDefinedPropertyDict). If propertyDict doesn't contains
		/// the Property so the exception is thrown.
		/// </summary>
		/// <typeparam name="T">The typeof the Property.</typeparam>
		...
		/// <summary>
		/// Returns dictionary with all object Properties. Joins properties from the base dictionary (propertyDict) 
		/// and from the user-defined dictionary (userDefinedPropertyDict).
		/// </summary>
		...
		/// <summary>
		/// Edits or sets given Property to the userDefinedPropertyDict (user defined Property).
		/// Also checks if the given object is really Property (if not the exception is thrown).
		/// </summary>
		...
		/// <summary>
		/// Updates all game actions of the object.
		/// </summary>
		...
		/// <returns>
		/// The Mogre.Vector3 parsed from given string
		/// </returns>
		/// <exception cref="System.FormatException">Thrown when cannot parse string to Mogre.Vector3.</exception>
