...
namespace Strategy.GameObjectControl.Game_Objects {
	...
	public interface IGameObject {
		...
		/// <summary>
		/// Gets or sets Team og the object. The team is indicator of a friendships and production.
		/// Also can be controled if it is player object by the team (team name is also unique).
		/// </summary>
		Team Team { get; set; }

		/// <summary>
		/// Returns the current state of the health. The hp indicates if the object is alive (more than 0).
		/// </summary>
		int Hp { get; }

		/// <summary>
		/// Returns the distance where the object may looking for the unit from its team.
		/// </summary>
		...
		/// <summary>
		/// Returns Property by the given name (base properties)
		/// </summary>
		...
		/// <summary>
		/// Returns a Property with given name (user defined properties)
		/// </summary>
		/// <typeparam name="T">The typeof the Property.</typeparam>
		...
		/// <summary>
		/// Inserts the given Property in IGameObject Property container.
		/// </summary>
		...
		/// <summary>
		/// Removes the Property from IGameObject container by the name. 
		/// </summary>
		...
		/// <summary>
		/// Returns a dictionary with all object Properties.
		/// </summary>
		/// <returns>Returns a dictionary with Properties as objects (runtime generic)</returns>
		...
		/// <summary>
		/// Sets all IGameObjects in ShoutDistance around this object (recursively) which are in a same Team to the given list.
		/// </summary>
		...
		/// <summary>
		/// Inserts given game action to the IGameAction container. The object will update all his IGameActions.
		/// </summary>
		/// <param name="gameAction">The inserting game action.</param>
		void AddIGameAction(IGameAction gameAction);

		/// <summary>
		/// Returns a list with all game actions of the object.
		/// </summary>
