...
namespace Strategy.GameObjectControl.Game_Objects.Bullet {
	...
	public class Missile : IBullet {
		...
		/// <param name="rec">The bullet hit reciever.</param>
		public Missile(Vector3 position, SolarSystem solSystem, Vector3 targetPosition, IBulletStopReciever rec) {
			...
			// Caluculates constants for hidden collision.
		...
		/// <summary>
		/// Updates position of the bullet and check a collision in a visible mode.
		/// </summary>
		...
		/// <summary>
		/// Updates position og the bullet and check collision in an invisible mode.
		/// </summary>
		/// <param name="delay">The delay between last two frames (seconds).</param>
		...
		/// <summary>
		/// Calculates collistion (using Rays) and checks distance between bullet and object which is getted by the Ray.
		/// </summary>
		...
		/// <summary>
		/// Counts distance between a point and a diagonal line (line representing bullet and its direction).
