...
namespace Strategy.GameObjectControl.Game_Objects.Bullet {
	/// <summary>
	/// Implements IBullet interface. Represents a second type of IBullet which has a power and an attact distance 
	/// from runtime Property and a slower attack speed (a longer cooldown).
	/// </summary>
	public class Missile2 : IBullet {
		...
		/// <summary>
		/// Returns the bullet maximum attack distance.
		/// </summary>
		...
		/// <summary>
		/// Updates the bullet position and check collision in a visible mode.
		/// </summary>
		...
		/// <summary>
		/// Updates the bullet position and check collision in an invisible mode.
		/// </summary>
		/// <param name="delay">The delay between last two frames (seconds).</param>
		...
		/// <summary>
		/// Calculates a collistion from Rays and check distance between bullet and object gets from the Ray result.
		/// </summary>
		...
		/// <summary>
		/// Counts distance between the point and the diagonal line (line representing bullet and its direction).
		...
		/// <summary>
		/// Transforms a Quaternion to Vector3 and return the direction vector. 
		/// </summary>
		...
		/// <summary>
		/// Removes the bullet from a SolarSystem and destroys SceneNode and Entity.
		/// </summary>
