...
namespace Strategy.GameObjectControl.Game_Objects.GameLoad {
	...
	public class XmlLoader {
		...
		private RunTimeCreator runtimeCtor;
		...
		/// <summary>
		/// Returns the Team relations.
		/// </summary>
		/// <returns>Returns the Team relations.</returns>
		...
		/// <param name="typeName">The type of the creating object.</param>
		/// <param name="args">The arguments of the object.</param>
		/// <returns>Returns the created IMovableGameObject.</returns>
		...
		/// </summary>
		/// <returns>Returns the dictionary with moving targets.</returns>
		...
		/// </summary>
		/// <returns>Returns the list with occupations.</returns>
		...
		/// </summary>
		/// <returns>Returns the list with fights.</returns>
		...
		/// <returns>Returns the unused name with given base.</returns>
		...
		/// </summary>
		/// <param name="materialNodeList">XmlNode of the materials to load.</param>
		...
		/// </summary>
		/// <param Name="teamsNode">The XML node with teams and frienships</param>
		...
		/// <returns>Returns the list with the InnerText of the argument subnodes.</returns>
		...
		private static Mogre.Vector3 ParseStringToVector3(string input) {
			...
			try {
				...
				throw new FormatException("Cannot parse string " + input + " to Mogre.Vector3. Given string was in a wrong format (right format: \"x;y;z\")");
			}
			return v;
		}
