...
namespace Strategy.GameObjectControl.Game_Objects.GameLoad {
	...
	public class RunTimeCreator {
		...
		#region Public
		/// <summary>
		/// Compiles all classes which are used in a mission.
		/// </summary>
		/// <param name="syntaxTreeList">The list with the SyntaxTrees (compiling classes).</param>
		/// <exception cref="XmlLoadException">Thrown when compilation failed.</exception>
		...
		/// </summary>
		/// <param name="fullName">The name of the creating type.</param>
		...
		/// <summary>
		/// Creates an object in runtime from compiled classes in dynamic assembly.
		/// </summary>
