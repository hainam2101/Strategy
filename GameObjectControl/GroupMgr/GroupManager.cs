...
namespace Strategy.GameObjectControl.GroupMgr {
	/// <summary>
	/// Controls objects and collects them to groups. Also selects groups and adds/removes members.
	/// </summary>
	public class GroupManager {

		private Dictionary<IMovableGameObject, GroupMovables> imgoGroupDict;
		...
		/// <summary>
		/// Removes the movable game object from group, from solar system and calls Destroy to remove object from the game.
		/// </summary>
		...
		/// <summary>
		/// Sets whole selected group as new empty groups and shows empty (by targetedMgr).
		/// </summary>
		...
		/// <summary>
		/// Checks every IMovableGameObject in the imgoList if is from the player's team.
