...
namespace Strategy.GameObjectControl.GroupMgr {
	...
	public abstract class IGroup<T> : IEnumerable
		...
		/// <summary>
		/// The list with members of the group.
		/// </summary>
		protected List<T> groupMembers;

		/// <summary>
		/// The Property with the team which is the owner of the group.
		/// </summary>
		protected Property<Team> team;

		/// <summary>
		/// The possible action for the group.
		/// </summary>
		...
		/// <summary>
		/// Returns dictionary with the group Properties. The virtual class returns empty dict.
		/// </summary>
		...
		/// <summary>
		/// Adds given Property to the dictionary. Stores Properties (object) to the given dictionary (summaryDict)
		...
		/// <summary>
		/// Finds all a common Properties and inserts them to a result dictionary, the rest of the Properties is replaced by the new 
		...
		/// <summary>
		/// Returns a reference to the team of the group.
		/// </summary>
		public Team Team {
	...
	/// <summary>
	/// IGroup specified on IMovbleGameObject with more functions.
	/// </summary>
	public class GroupMovables : IGroup<IMovableGameObject> {
		...
		/// <summary>
		/// Recounts and sets a bonuses (Select).
		/// </summary>
		...
		/// </summary>
		/// <returns>Returns a dictionary with all Properties (common unganed, others with '?' value).</returns>
	...
	public class GroupStatics : IGroup<IStaticGameObject> {
		...
		/// <summary>
		/// Collects group Properties, checks if they are common (real valeu/'?')
