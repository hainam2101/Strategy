...
namespace Strategy.GameObjectControl.RuntimeProperty {
	...
	public class PropertyManager {
		...
		/// <summary>
		/// Controls a delay between file changes (delay must be longer then 5 seconds when is less so properties are not reloaded)
		...
		private static void OnChanged(object source, FileSystemEventArgs e) {
			DateTime lastWriteTime = File.GetLastWriteTime(e.FullPath); // Bug fix - function is called twice bz the system
		...
		/// <summary>
		/// Adds generic property into the baseDict (or modify).
		...
		/// </summary>
		/// <param name="missionPropFilePath">The string with the mission file path.</param>
		...
		/// <returns>
		/// Returns generic instance of Property found by name.
		/// </returns>
		...
		/// <summary>
		/// Loads all properties from executing file and save them as generic Property by a name.
		/// </summary>
