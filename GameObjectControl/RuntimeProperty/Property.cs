...
namespace Strategy.GameObjectControl.RuntimeProperty {
	/// <summary>
	/// Stores the value and all object which has a reference to this Property can
	...
	public class Property<T> : ICloneable {
		...
		/// </summary>
		/// <returns>Returns copy of the Property</returns>
		public object Clone() {
		...
		/// </returns>
		/// <exception cref="System.ArgumentException">Thrown when the operator is not Plus or Minus.</exception>
		...
		/// <summary>
		/// Calls ExecuteTheOperation with this Property value and with the given Property value.
